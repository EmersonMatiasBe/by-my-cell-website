  ...
  teamSection: {
    ...
    text: (
      <>
        ...
        Laboratório é onde a ciência ganha vida, realizando análises precisas de diversos tipos de
        amostras. A Bioinformática transforma dados complexos em relatórios claros com informações
        valiosas para os clientes. O Marketing conecta nossa inovação ao mercado, comunicando valor
        e construindo relacionamentos sólidos. A equipe de Vendas é o nosso elo direto com os
        clientes, aproximando o mercado das nossas soluções. Tudo isso é sustentado pela Gestão de
        pessoas, que desenvolve talentos e fortalece nossa missão de facilitar o acesso à genômica.
        Juntos, esses setores formam a ByMyCell, uma empresa comprometida em revolucionar o
        agronegócio e a pesquisa brasileira por meio da ciência e da tecnologia.
      </>
    )
  }
}
